...
from agenda_tarefa import Tarefa
from cria_email import Email
...
def main(page: ft.Page):
    ...
    def cria_tarefa(e):
        ...
        status = Tarefa(
            nome_tarefa=dados_tarefa['nome'],
            desc_tarefa=dados_tarefa['descricao'],
            tipo_tarefa=dados_tarefa['tipo'],
            intervalo= dados_tarefa['intervalo'],
            dias=ast.literal_eval(dados_tarefa['dias']),
            inicio=dados_tarefa['data'], 
            fim=dados_tarefa['dataFim'], 
            caminho_executavel = caminho_execucao +'/AutoEmail.exe',
            argumento = tarefaSelecionada.replace(' ', '_')
            ).run()
        if status:
